...
QT_MOC_LITERAL(7, 56, 4), // "flag"
QT_MOC_LITERAL(8, 61, 18), // "progressBarChanged"
QT_MOC_LITERAL(9, 80, 5), // "value"
QT_MOC_LITERAL(10, 86, 18), // "slotLineNumChanged"
QT_MOC_LITERAL(11, 105, 21), // "minTiffMappingChanged"
QT_MOC_LITERAL(12, 127, 21), // "maxTiffMappingChanged"
QT_MOC_LITERAL(13, 149, 15), // "slotShowMiniMap"
QT_MOC_LITERAL(14, 165, 6) // "isShow"

    },
    "LeftLayout\0lineNumChanged\0\0n\0"
    "tiffMappingChanged\0min\0max\0flag\0"
...
void LeftLayout::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 1: _t->tiffMappingChanged((*reinterpret_cast< int(*)>(_a[1])),(*reinterpret_cast< int(*)>(_a[2])),(*reinterpret_cast< int(*)>(_a[3]))); break;
        ...
        {
            typedef void (LeftLayout::*_t)(int , int , int );
...
// SIGNAL 1
void LeftLayout::tiffMappingChanged(int _t1, int _t2, int _t3)
{
